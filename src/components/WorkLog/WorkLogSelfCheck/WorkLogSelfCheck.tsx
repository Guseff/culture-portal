...
const WorkLogSelfCheck = ({ selfCheck }) => {
  return (
    <Form>
      ...
      <h5 className="mt-3">{selfCheck.normalTitle}</h5>
      ...
      <h5 className="mt-3">{selfCheck.extraTitle}</h5>
      ...
      <h5 className="mt-3">{selfCheck.finesTitle}</h5>
      ...
      <h4 className="mt-3">{`${selfCheck.total} 280/280`}</h4>
    </Form>
  );
};
